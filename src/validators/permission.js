...
exports.addPermissionValidation = Joi.object({
  actionName: Joi.string().trim().optional().messages({ "string.empty": "Action name is required" }),
  description: Joi.string().trim().optional().messages({ "string.empty": "Description is required" }),
